...
if __name__ == '__main__':
    ...
    replace_values_from_another_sheet(xlsx_file, 'income', 'Счёт', 'account_category', 'id', 'Название')
    replace_values_from_another_sheet(xlsx_file, 'income', 'Валюта', 'currency', 'id', 'Название')
